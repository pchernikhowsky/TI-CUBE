...
In it's basic form the TI CUBE supports serial communications, 32KB of RAM and 32KB of ROM.
...
-  TIM9904 (48 MHz crystal) or TIM9904A (12 Mhz crystal) clock generator
...
2. **Memory board**
-  2x EPROMs (2764, 27128, 27256) for up to 32 KB of EPROM
-  2x static RAM (55256) for up to 32 KB of RAM
-  ATF16V8 PLD for address decoding
